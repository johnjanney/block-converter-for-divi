(function ($) {
    ...
    $(function () {
        ...
        function renderPagination() {
            ...
            var html = '';
            html += '<a class="first-page button' + (currentPage <= 1 ? ' disabled' : '') + '" data-page="1" title="First page">&laquo;</a> ';
            html += '<a class="prev-page button' + (currentPage <= 1 ? ' disabled' : '') + '" data-page="' + (currentPage - 1) + '" title="Previous page">&lsaquo;</a> ';
            html += '<span class="paging-input">' + currentPage + ' of <span class="total-pages">' + totalPages + '</span></span> ';
            html += '<a class="next-page button' + (currentPage >= totalPages ? ' disabled' : '') + '" data-page="' + (currentPage + 1) + '" title="Next page">&rsaquo;</a> ';
            html += '<a class="last-page button' + (currentPage >= totalPages ? ' disabled' : '') + '" data-page="' + totalPages + '" title="Last page">&raquo;</a>';
        ...
        $pagination.on('click', 'a.button:not(.disabled)', function (e) {
            e.preventDefault();
        ...
        $scanBtn.on('click', function () {
            ...
            $.post(d2g.ajax_url, {
                ...
                $btn.prop('disabled', false).text('Scan for Divi Pages');
                showStatus('Scan failed: ' + textStatus + (errorThrown ? ' — ' + errorThrown : ''), 'error');
            });
        });
