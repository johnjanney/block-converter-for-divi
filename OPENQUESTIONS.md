...
| Q13 | 2026-08-04 | P3 | Housekeeping | There is no `uninstall.php` and no `LICENSE` file despite the GPL-2.0-or-later header. On uninstall, should `_d2g_divi_backup` meta be purged (clean) or deliberately retained (safe)? |
